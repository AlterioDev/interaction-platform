...
<body class="antialiased">
    <div class="container">
        ...
        <table>
            <tr>
                <td>List all allowed locations for the user</td>
                <td>GET</td>
                <td><a href="/v2/locations">/v2/locations</a></td>
                <td>-</td>
            </tr>
            <tr>
                <td>Get location by id</td>
                <td>GET</td>
                <td><a href="/v2/location/{id}">/v2/location/{id}</a></td>
                <td>-</td>
            </tr>
            <tr>
                <td>Add new location</td>
                <td>POST</td>
                <td><a href="/v2/location/add">/v2/location/add</a></td>
                <td>name / address / postal_code / city / country / latitude / longitude / timezone / MetaData</td>
            </tr>
            <tr>
                <td>Update a location</td>
                <td>POST</td>
                <td><a href="/v2/location/update/{id}">/v2/location/update/{id}</a></td>
                <td>name / address / postal_code / city / country / latitude / longitude / timezone / MetaData</td>
            </tr>
            <tr>
                <td>Delete a location</td>
                <td>GET</td>
                <td><a href="/v2/location/delete/{id}">/v2/location/delete/{id}</a></td>
                <td>-</td>
            </tr>
        </table>
        <table>
            <tr>
                ...
                <td>GET</td>
                <td><a href="/v2/locations">/v2/devices</a></td>
                <td>-</td>
            </tr>
            <tr>
                <td>Get device by id</td>
                <td>GET</td>
                <td><a href="/v2/locations">/v2/devices/{id}</a></td>
                <td>-</td>
            </tr>
            <tr>
                <td>Add new device</td>
                <td>POST</td>
                <td><a href="/v2/location/add">/v2/devices/add</a></td>
                <td>name / type / MetaData</td>
            </tr>
            <tr>
                <td>Update a device</td>
                <td>POST</td>
                <td><a href="/v2/location/add">/v2/devices/update</a></td>
                <td>name / type / MetaData</td>
            </tr>
            <tr>
                <td>Delete a device</td>
                <td>GET</td>
                <td><a href="/v2/location/add">/v2/devices/delete/{id}</a></td>
                <td>-</td>
            </tr>
        </table>
